...
<div class="row" style=" position: relative;top: 80px; margin: 10px 10px 10px 10px;">
  ...
  <div class="col-sm-3">
      <div class="row align-items-center;" style="border: 2px outset #ff4069; margin: 5px 5px 5px 5px; border-radius:12px;" data-id_card="I15">
        <div class="col">
          <img src="Img/inflable1.jpg" class="card-img-top w-100" style="margin-top:8px;" alt="..." style="">
        </div>
        <div class="col">
        <h5 class="card-title">Inflable x13m Mini</h5> 
		 <button type="button" class="inflatable-button btn btn-outline-dark" style="margin-top: 5px; margin-left: 2%; background-color: #00cea6; text-decoration: none; font-size: 12px;"  >
           <!-- <img src="Img/What.png" style="width: 30px;"> -->
          Añade al carrito	  
         </button> 
      </div>
	  <p> <small> Inflable para 6 niños </small> </p>
      </div>
    </div>
	
	<div class="col-sm-3">
      <div class="row align-items-center;" style="border: 2px outset #ff4069; margin: 5px 5px 5px 5px; border-radius:12px;" data-id_card="I14">
        <div class="col">
          <img src="Img/inflable2.jpg" class="card-img-top w-100 " style="margin-top:8px;" alt="..." style="">
        </div>
        <div class="col">
        <h5 class="card-title">Inflable x12m Cómico</h5> 
		 <button type="button" class="inflatable-button btn btn-outline-dark" style="margin-top: 5px; margin-left: 2%; background-color: #00cea6; text-decoration: none; font-size: 12px;"  >
           <!-- <img src="Img/What.png" style="width: 30px;"> -->
          Añade al carrito
         </button> 
      </div>
	  <p> <small> Inflable para 10 niños </small> </p>
      </div>
    </div>
	
	<div class="col-sm-3">
      <div class="row align-items-center;" style="border: 2px outset #ff4069; margin: 5px 5px 5px 5px; border-radius:12px;" data-id_card="I13">
        <div class="col">
          <img src="Img/inflable3.jpg" class="card-img-top w-100 " style="margin-top:8px;" alt="..." style="">
        </div>
        <div class="col">
        <h5 class="card-title">Inflable x6m Loco</h5> 
		 <button type="button" class="inflatable-button btn btn-outline-dark" style="margin-top: 5px; margin-left: 2%; background-color: #00cea6; text-decoration: none; font-size: 12px;"  >
           <!-- <img src="Img/What.png" style="width: 30px;"> -->
          Añade al carrito
         </button> 
      </div>
	  <p> <small> Inflable para 15 niños  </small> </p>
      </div>
    </div>
	
	<div class="col-sm-3">
      <div class="row align-items-center;" style="border: 2px outset #ff4069; margin: 5px 5px 5px 5px; border-radius:12px;" data-id_card="I12">
        <div class="col">
          <img src="Img/inflable4.jpg" class="card-img-top w-100 " style="margin-top:8px;" alt="..." style="">
        </div>
        <div class="col">
        <h5 class="card-title">Inflable x3m Mega</h5> 
		 <button type="button" class="inflatable-button btn btn-outline-dark" style="margin-top: 5px; margin-left: 2%; background-color: #00cea6; text-decoration: none; font-size: 12px;"  >
           <!-- <img src="Img/What.png" style="width: 30px;"> -->
          Añade al carrito
	  ...
	  <p> <small> Inflable para 24 niños </small> </p>
      </div>
    </div>
